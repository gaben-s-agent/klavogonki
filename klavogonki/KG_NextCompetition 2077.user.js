...
(async function() {
    ...
    async function httpGet(url) {
        ...
        return new Promise((resolve, reject) => {
            ...
            xhr.onerror = () => reject(console.log('ERROR', xhr.statusText));
            xhr.send();
        });
    }
    ...
    let shareBtn = '<svg id="next-competition-2077-share" viewBox="0 0 24 24" style="width: 1em;"><title>Отправить в чат</title>'+
    ...
    let backBtn = '<svg id="next-competition-2077-back" viewBox="0 0 512.001 512.001" style="display:none; width: 1em;"><title>Вернуться в прошлый режим</title>' +
